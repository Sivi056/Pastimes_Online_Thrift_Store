...
<body class="<?php echo $theme; ?>">
    ...
    <div class="container" style="max-width: 600px; margin-top: 30px;">
        <div
            style="background: white; padding: 30px; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); color: #333;">
            <h2 style="margin-top: 0;">👕 List an Item for Sale</h2>
            <p style="color: #666; font-size: 0.9em;">Submit your vintage piece or sneakers. Items are verified by
                administration within 24 hours.</p>
            ...
            <form method="POST" enctype="multipart/form-data" style="display: flex; flex-direction: column; gap: 15px;">
                <div>
                    ...
                    <input type="text" name="item_name" required placeholder="e.g. Vintage Nike Windbreaker"
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="price" required placeholder="R 0.00"
                        style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 4px;">
                </div>
                <div>
                    <label style="font-weight: bold; display: block; margin-bottom: 5px;">Condition & Details
                        Description:</label>
                    <textarea name="description" rows="4" required
                        placeholder="Describe condition flaws, sizing fit details, authenticity tracking tags..."
                        style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 4px; font-family: sans-serif;"></textarea>
                </div>
                <div>
                ...
                <button type="submit" name="submit_clothing" class="btn-gold"
                    style="padding: 12px; font-size: 1em; font-weight: bold; margin-top: 10px;">Submit Verification
                    Request</button>
            </form>
        </div>
    </div>
